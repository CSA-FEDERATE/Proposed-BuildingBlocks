...
(Other/more general open source imlementations include e.g. journald, or specialized solutions like the Rust defmt crate)

## ID (unique name)

## Description
<!-- General Description of the BB -->
Logging service for S-CORE systems
