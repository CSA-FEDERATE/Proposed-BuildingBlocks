...
If you want to communicate efficiently between multiple processes or applications iceoryx2 is for you. With iceoryx2, you can:
...
- Abandoned
 -->
First public release available (probably already used in production - to be verified)
